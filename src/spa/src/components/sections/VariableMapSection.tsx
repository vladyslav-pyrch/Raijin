        ...
        <section className="card">
            ...
            {fetched && variableMap && (
                <div className="px-4 py-3 space-y-2">
                    ...
                    {/* Table */}
                    <div
                        className="overflow-auto max-h-64 border border-neutral-200 dark:border-neutral-700 rounded-md">
                        <table className="w-full text-xs">
                            <thead className="table-header sticky top-0">
                            <tr>
                                <th className="text-left px-4 py-2 font-medium w-20 text-neutral-500 dark:text-neutral-400">Index</th>
                                <th className="text-left px-4 py-2 font-medium text-neutral-500 dark:text-neutral-400">Variable
                                    name
                                </th>
                            </tr>
                            </thead>
