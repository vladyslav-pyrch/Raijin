    ...
    return (
        <div className="space-y-4">
            <div>
                ...
                <table
                    className="w-full text-sm border border-neutral-200 dark:border-neutral-700 rounded-md overflow-hidden">
                    <thead className="table-header">
                    <tr>
                        <th className="text-left px-3 py-2 text-xs font-medium text-neutral-500 dark:text-neutral-400">Variable</th>
                        <th className="text-left px-3 py-2 text-xs font-medium text-neutral-500 dark:text-neutral-400">Assigned
                            state
                        </th>
                    </tr>
                    </thead>
            ...
            <div className="overflow-auto max-h-48 border border-neutral-200 dark:border-neutral-700 rounded-md">
                <table className="w-full text-xs">
                    ...
                    <tr>
                        ...
                        <th className="text-left px-3 py-2 font-medium text-neutral-500 dark:text-neutral-400">Color #
                        </th>
                    </tr>
                    </thead>
                    <tbody>
