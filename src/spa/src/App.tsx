...
function AppLayout() {
    ...
    return (
        <div className="flex flex-col h-screen bg-neutral-50 dark:bg-surface text-neutral-900 dark:text-neutral-100">
            ...
            {/* Top navigation bar */}
            <header
                className="sticky top-0 z-10 flex items-center shrink-0 min-h-[48px] px-4 gap-4 bg-neutral-900 dark:bg-neutral-900 shadow-md">
                <button
                    onClick={() => navigate('/')}
          ...
          Combinatorics Solver
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                {/* Sidebar */}
                <aside
                    className="w-64 shrink-0 flex flex-col overflow-hidden border-r border-neutral-200 dark:border-neutral-700 bg-white dark:bg-surface-secondary">

                    {/* Sidebar header */}
                    <div
                        className="px-3 py-2 border-b border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-surface-tertiary flex items-center justify-between shrink-0">
            <span className="text-xs font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">
              Problems
                    ...
                    {totalPages > 1 && (
                        <div
                            className="flex items-center justify-between px-3 py-2 border-t border-neutral-200 dark:border-neutral-700 text-xs shrink-0">
                ...
                {page} / {totalPages}
                            ...
                            <Button size="sm" variant="ghost" onClick={() => loadPage(page + 1)}
            ...
            {/* Footer */}
            <footer
                className="shrink-0 min-h-[36px] border-t border-neutral-200 dark:border-neutral-700 bg-white dark:bg-surface-secondary"/>
        </div>
    );
}
